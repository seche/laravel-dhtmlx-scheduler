...
class Scheduler
{
     ...
     * see https://docs.dhtmlx.com/scheduler/api__refs__scheduler.html#properties
     *
     * @var array
     */
    ...
    {
        return '<div id="scheduler_' . $this->getId() . '" class="dhx_cal_container" style="width:100%; height:100%;">
